...
public class ResultActivity extends AppCompatActivity {
    ...
    double BMR,totalcalburn;
      TextView resulttxt , resulttextview2, finalResult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finalResult = findViewById(R.id.dummytxtid);
        ...
        getresultbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(inputcals)){
                    ...
                    if (deficit < 0){
                        // calorie surplus
                        finalResult.setText("Total calorie surplus:");
                        resulttxt.setText(String.valueOf(abs(round(deficit, 2))));

                    } else {
                        //calorie deficit
                        finalResult.setText("Total calorie deficit:");
                        resulttxt.setText(String.valueOf(abs(round(deficit, 2))));
                    }
...
//                    resulttextview2.setText(String.valueOf(round(totalcalburn,2)));
    ...
    private void calcualtebmi()
    {
        ...
        resulttextview2.setText("BMR Value is "+round(BMR, 2)+" Calories/day");
    }
